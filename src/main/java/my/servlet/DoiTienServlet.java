...
public class DoiTienServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DoiTienServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    private void TinhTienViet() {
        ...
        switch (loaiNgoaiTe) {
            case "USD":
                tienViet = soTienQuyNgoaiTe * 21.380;
                break;
            case "GBP":
                tienViet = soTienQuyNgoaiTe * 32.62280;
            default:
